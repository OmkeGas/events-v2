...
<section>
    ...
    <!-- Form -->
        <section class="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 mx-auto max-w-6xl">
            <form action="<?= BASE_URL ?>/event/update/<?= $data['event']['id'] ?>" method="post" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid gap-4 grid-cols-2 sm:grid-cols-3 md:grid-cols-4 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" id="start_time" name="start_time"
                                   value="<?=  $data['event']['start_time'] ?: '08:00' ?>"
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative">
                            ...
                            <input type="time" id="end_time" name="end_time"
                                   value="<?=  $data['event']['end_time'] ?: '16:00' ?>"
                    ...
                    <div class="w-full">
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-buttons datepicker-autoselect-today id="registration_deadline" name="registration_deadline"
                                   value="<?= isset($data['event']['registration_deadline']) ? $data['event']['registration_deadline'] : old('registration_deadline') ?>"
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="location_address" id="location_address"
                               value="<?= $data['event']['location_address'] ?>"
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="location_link" id="location_link"
                               value="<?= $data['event']['location_link'] ?>"
                    ...
                    <div class="w-full col-span-full sm:col-span-2">
                        ...
                        <textarea id="short_description" name="short_description" rows="12" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border <?= Validator::hasError('short_description') ? 'border-red-500' : 'border-gray-300' ?> focus:ring-blue-500 focus:border-blue-500" placeholder="..."><?= $data['event']['short_description'] ?></textarea>
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="thumbnail" class="flex flex-col items-center justify-center w-full h-64 border-2  <?= Validator::hasError('thumbnail') ? 'border-red-500' : 'border-gray-300' ?> border-dashed rounded-lg cursor-pointer bg-gray-50">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6" id="thumbnail-preview-container">
                                    <img id="thumbnail-preview" src="<?=BASE_URL?>/images/events/<?=$data['event']['thumbnail']?>"  alt="<?=$data['event']['title']?>" class=" mb-4 w-auto h-40 object-contain rounded-lg" />
                                    <svg id="thumbnail-placeholder" class="hidden w-8 h-8 mb-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                    ...
                    <div class="w-full">
                        ...
                        <select id="is_published" name="is_published"
                            ...
                            <option value="n" <?= $data['event']['is_published'] == '0' ? 'selected' : '' ?>>Draft</option>
                            <option value="y" <?= $data['event']['is_published'] == '1' ? 'selected' : '' ?>>Publish</option>
                        </select>
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="full_description" name="full_description" class="<?= Validator::hasError('full_description') ? 'border-red-500' : '' ?>"><?= $data['event']['full_description'] ?></textarea>
