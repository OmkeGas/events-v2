    ...
    <div class="container max-w-screen-xl mx-auto px-4">
        ...
        <?php if (isset($_SESSION['flash'])): ?>
            <div id="flashMessage"
                ...
                <button type="button"
                        ...
                        data-dismiss-target="#flashMessage" aria-label="Close">
        ...
        <?php if (empty($data['registrations'])): ?>
            ...
            <div class="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <p class="text-gray-600 mb-6">You haven't registered for any events. Start by exploring our available
                    events.</p>
                <a href="<?= BASE_URL ?>/event"
                   class="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Browse Events
                                                                ...
                                                                <div class="mb-4 md:mb-0">
                                                                    ...
                                                                    <span class="font-medium">
                                                                        <?= strtoupper(date('M d, Y', strtotime($registration['start_date']))) ?>
                                                                                                ...
                                                                                                <span class="font-medium">
                                                                        <?= date(':i A', strtotime($registration['start_time'])) ?> (WIB)
                                                                    </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="md:w-2/3 md:pl-6">
                                                                ...
                                                                <div class="grid grid-cols-2 gap-4 mb-4">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="text-gray-900 text-sm font-mono font-medium   ">
                                                                            <?= strtoupper(date('M d, Y', strtotime($registration['registration_date']))) ?>
                                                                        </p>
                                                                    </div>
                                                                </div>
